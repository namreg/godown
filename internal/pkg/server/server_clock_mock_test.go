...
The original interface "serverClock" can be found in github.com/namreg/godown-v2/internal/pkg/server
*/
import (
	"sync/atomic"
	time "time"
...
//serverClockMock implements github.com/namreg/godown-v2/internal/pkg/server.serverClock
...
//NewserverClockMock returns a mock for github.com/namreg/godown-v2/internal/pkg/server.serverClock
...
//Now implements github.com/namreg/godown-v2/internal/pkg/server.serverClock interface
