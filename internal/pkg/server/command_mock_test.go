...
import (
	...
	command "github.com/namreg/godown-v2/internal/pkg/command"
	storage "github.com/namreg/godown-v2/internal/pkg/storage"

	testify_assert "github.com/stretchr/testify/assert"
)

//CommandMock implements github.com/namreg/godown-v2/internal/pkg/command.Command
type CommandMock struct {
	t minimock.Tester

	ExecuteFunc       func(p storage.Storage, p1 ...string) (r command.Result)
...
//NewCommandMock returns a mock for github.com/namreg/godown-v2/internal/pkg/command.Command
...
func (m *mCommandMockExecute) Return(r command.Result) *CommandMock {
	m.mock.ExecuteFunc = func(p storage.Storage, p1 ...string) command.Result {
		return r
	}
	return m.mock
}
...
func (m *mCommandMockExecute) Set(f func(p storage.Storage, p1 ...string) (r command.Result)) *CommandMock {
	m.mock.ExecuteFunc = f
	return m.mock
}

//Execute implements github.com/namreg/godown-v2/internal/pkg/command.Command interface
func (m *CommandMock) Execute(p storage.Storage, p1 ...string) (r command.Result) {
...
//Help implements github.com/namreg/godown-v2/internal/pkg/command.Command interface
...
//Name implements github.com/namreg/godown-v2/internal/pkg/command.Command interface
