...
func TestRpush_Name(t *testing.T) {
	cmd := new(Rpush)
	assert.Equal(t, "RPUSH", cmd.Name())
}

func TestRpush_Help(t *testing.T) {
	cmd := new(Rpush)
	expected := `Usage: RPUSH key value [value ...]
Append one or multiple values to a list.`
	assert.Equal(t, expected, cmd.Help())
}

func TestRpush_Execute(t *testing.T) {
...
func TestRpush_Execute_WhiteBox(t *testing.T) {
...
func TestRpush_Execute_StorageErr(t *testing.T) {
