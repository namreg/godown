...
//StorageMock implements github.com/namreg/godown-v2/internal/command.commandStorage
...
//NewStorageMock returns a mock for github.com/namreg/godown-v2/internal/command.commandStorage
...
//StorageMockDelParams represents input parameters of the commandStorage.Del
...
//StorageMockGetParams represents input parameters of the commandStorage.Get
...
//Lock implements github.com/namreg/godown-v2/internal/command.commandStorage interface
...
//StorageMockPutParams represents input parameters of the commandStorage.Put
...
func (m *mStorageMockPut) Expect(p storage.Key, p1 *storage.Value) *mStorageMockPut {
...
func (m *mStorageMockPut) Set(f func(p storage.Key, p1 *storage.Value) (r error)) *StorageMock {
	m.mock.PutFunc = f
	return m.mock
}

//Put implements github.com/namreg/godown-v2/internal/command.commandStorage interface
func (m *StorageMock) Put(p storage.Key, p1 *storage.Value) (r error) {
...
//RLock implements github.com/namreg/godown-v2/internal/command.commandStorage interface
...
//RUnlock implements github.com/namreg/godown-v2/internal/command.commandStorage interface
...
//Unlock implements github.com/namreg/godown-v2/internal/command.commandStorage interface
